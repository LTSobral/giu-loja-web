...
<table class="table table-ligth table-striped">
      ...
      <?php 
       ...
       ?>
            ...
            <tr align="right"><td colspan="8"><font face="Verdana" size="4" color="red"><b><?= $soma ?></b></font></td></tr>
      </table> 
      <div class="container text-center">
            <div class="row">
                  ...
                  <div class="col">
                        <a class="btn btn-danger" role="button" href="../controlers/controlerCarrinho.php?opcao=3"><b>Esvaziar carrinho</b></a>
                  </div>
                  <div class="col">
                        <a class="btn btn-success" role="button" href="../controlers/controlerCarrinho.php?opcao=5&total=<?=$soma?>"><b>Finalizar compra</b></a>
                  </div>
            </div>
      </div>
