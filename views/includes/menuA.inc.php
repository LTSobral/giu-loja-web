  ...
  <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="../controlers/controlerFabricante.php?opcao=2">Cadastrar</a></li>
    ...
    <li>
      <a class="nav-link px-2 link-dark" href="../controlers/controlerCarrinho.php?opcao=4">
